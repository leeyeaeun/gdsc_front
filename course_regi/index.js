...
var courseGet= new Promise((resolve, reject)=>{
  fs.readFile('data/course_data2.json', function(err, data){
    if (err){
      reject(err)
    }
    resolve('got course')
...
var indexGet= new Promise((resolve, reject)=>{
  fs.readFile('data/indexNsize.json', function(err, data){
    if (err){
      reject(err)
    }
    resolve('got index')
...
var AIget=new Promise((resolve, reject)=>{
  fs.readFile('data/AI_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var BSget=new Promise((resolve, reject)=>{
  fs.readFile('data/BS_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var CHget=new Promise((resolve, reject)=>{
  fs.readFile('data/CH_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var CTget=new Promise((resolve, reject)=>{
  fs.readFile('data/CT_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var ECget=new Promise((resolve, reject)=>{
  fs.readFile('data/EC_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var EVget=new Promise((resolve, reject)=>{
  fs.readFile('data/EV_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var FEget=new Promise((resolve, reject)=>{
  fs.readFile('data/FE_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var GSget=new Promise((resolve, reject)=>{
  fs.readFile('data/GS_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var IRget=new Promise((resolve, reject)=>{
  fs.readFile('data/IR_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var MAget=new Promise((resolve, reject)=>{
  fs.readFile('data/MA_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var MCget=new Promise((resolve, reject)=>{
  fs.readFile('data/MC_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var MDget=new Promise((resolve, reject)=>{
  fs.readFile('data/MD_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var MMget=new Promise((resolve, reject)=>{
  fs.readFile('data/MM_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
var UCget=new Promise((resolve, reject)=>{
  fs.readFile('data/UC_courses.json', function(err, data){
    if (err){
      reject(err)
    }
...
function seat_results(time_diff, end_time, course_count){
  ...
  for (i=0; i<course_count; i++){
    ...
    let seats_left=seats_i-Math.floor((time_diff-10000)/(end_time*1000/seats_i))
    if (seats_left<0){
      arr_seats.push({
...
app.get('/', (req, res) => {//다 한꺼번에 줄어들어야 함. 지금은 한 과목만
